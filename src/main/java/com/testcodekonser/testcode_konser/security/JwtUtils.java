package com.testcodekonser.testcode_konser.security;
...
import com.testcodekonser.testcode_konser.model.JwtClaim;
...
public class JwtUtils {
    ...
    @Value("${app.testcode-konser.jwt-secret}")
    private String secretKey;
    @Value("${app.testcode-konser.jwt-expiration}")
    private Long expirationInSecond;
    @Value("${app.testcode-konser.jwt-app-name}")
